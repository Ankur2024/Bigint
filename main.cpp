...
int main() {
    ...
    cout << "After incrementing twice: " << a << endl;

    BigInt b("456");
    cout << "Before decrement: " << b << endl;
    cout << "After prefix decrement: " << --b << endl;
    cout << "After postfix decrement: " << b-- << endl;
    cout << "After decrementing twice: " << b << endl;

       // Perform other operations
        BigInt power = num1 ^ BigInt(5); // Cube of num1
        BigInt sqrtNum2 = sqrt(num2); // Square root of num2
        BigInt catalan10 = NthCatalan(10); // 10th Catalan number
        BigInt fib10 = NthFibonacci(1000); // 10th Fibonacci number
        BigInt fact10 = Factorial(100); // Factorial of 10
